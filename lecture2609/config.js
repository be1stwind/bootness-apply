...
var 회차 = {
  ...
  title:    '전해청 변호사님의 『부동산 법률 분쟁의 예방 및 대응방안』',  // 강사님 강의개요 v3 (2026-09-16)
  when:     '9월 19일 (토) 오후 3시 ~ 6시',
  place:    '강남역 11번 출구 배움자리 40인실 (서울 강남구 테헤란로5길 31, 3층)',  // 9/16 오너 「넣기」(한결 전달 · 주소는 8월 특강공지 PPT). 비어 있으면 「📍 장소」 줄이 안 보인다
  placeUrl: '',                                     // ⬜ 지도 링크 (naver.me/…) — 아직 못 찾음. 오너가 주시면 채운다
